             ...
             */
                switch (browserType) {
                    ...
                    case "mobile":
                        ...
                        desiredCapabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Foreks");
                        desiredCapabilities.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, 20000);
                        try {
                            driverPool.set(new RemoteWebDriver(new URL("http://0.0.0.0:4723/wd/hub"),desiredCapabilities));
                        } catch (MalformedURLException e) {
                            e.printStackTrace();
                        }
